...
# 📖 Task todo App<a name="about-project"></a>

**This is a simple todo-list App that was develop with JavaScript language. It displays list of task, allows the user to 
create a new task, mark the task as completed  and delete them from local storage.**
...
- **This is not the final project. many pages and functionalities will be Added to display other relevant content.**
- **Remove Task: every task entered can be removed**
- **This App will Save and mark task completed**
...
- I would like thank Microverse Review Team and especially Abel Gebeyehu for professional review and feedback. My Coding Partners, wish I could mention your names. cheers!! to you all. I, Evans, and my Family.😀
